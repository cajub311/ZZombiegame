// Faction Wars service worker — offline caching for the installed app.
const CACHE = "fw-v1";
const ASSETS = ["./", "./index.html", "./classic.html", "./manifest.json", "./icon-192.png", "./icon-512.png", "./icon-512-maskable.png"];
